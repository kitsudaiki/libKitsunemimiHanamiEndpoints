...
SOURCES += \
    endpoint.cpp \
    endpoint_parsing/endpoint_parser_interface.cpp

HEADERS += \
    ../include/libKitsunemimiHanamiEndpoints/endpoint.h \
    endpoint_parsing/endpoint_parser_interface.h


FLEXSOURCES = grammar/endpoint_lexer.l
BISONSOURCES = grammar/endpoint_parser.y
...
# The resulting source-code-files are stored in the build-directory of the endpoint-converter.
